...
data class GameSummary(
    ...
    @field:JsonProperty("Player1Corp") val player1Corp: String,
    ...
    @field:JsonProperty("Player2Corp") val player2Corp: String,
    ...
    @field:JsonProperty("Player3Corp") val player3Corp: String? = null,
    ...
    @field:JsonProperty("Player4Corp") val player4Corp: String? = null,
    ...
    @field:JsonProperty("Player5Corp") val player5Corp: String? = null,
